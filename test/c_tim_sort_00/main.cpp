...
TEST(TimSortTest, EmptyArray)
{
    ...
    rcn_c::tim_sort(arr, NR_ELEM(arr), sizeof(arr[0]), IntCompar);
    ASSERT_EQ(NR_ELEM(arr), 0);
}

TEST(TimSortTest, SingleElementArray)
{
    int arr[] = { 5 };
...
TEST(TimSortTest, AlreadySortedArray)
{
    int arr[] = { 1, 2, 3, 4, 5 };
...
TEST(TimSortTest, ReverseSortedArray)
{
    int arr[] = { 5, 4, 3, 2, 1 };
