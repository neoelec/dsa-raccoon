...
TEST(ShellSortTest, EmptyArray)
{
    ...
    rcn_c::shell_sort(arr, NR_ELEM(arr), sizeof(arr[0]), IntCompar);
...
TEST(ShellSortTest, AlreadySortedArray)
{
    int arr[] = { 1, 2, 3, 4, 5 };
...
TEST(ShellSortTest, DuplicateElements)
{
